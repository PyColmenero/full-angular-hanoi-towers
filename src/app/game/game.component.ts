...
export class GameComponent implements AfterViewInit  {
	...
	build_tree(){
		...
		// LISTA DE DISCOS
		this.hanoi_disks = [];
		this.hanoi_disks.push({id:this.hanoi_disk_amount, size:0, x:0, y:0, next:undefined});
	...
	resize(){
		this.get_map_size();
		this.map_height = (this.tower_width*3) / 2;
	...
	get_map_size(){
		this.tower_width = this.map.nativeElement.offsetWidth/3;
		this.map_height = this.map.nativeElement.offsetHeight;
	}
